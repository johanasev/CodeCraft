"""
Django settings for CodeCraft_backend project.
"""
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Para CORS con React
    'drf_spectacular',  # Para documentación API con Swagger
    
    # Local apps
    'inventory',  # Tu app principal
]
...
ROOT_URLCONF = 'CodeCraft_backend.urls'
...
WSGI_APPLICATION = 'CodeCraft_backend.wsgi.application'
...
# Spectacular settings para Swagger/OpenAPI
SPECTACULAR_SETTINGS = {
    'TITLE': 'CodeCraft API',
    'DESCRIPTION': 'API para sistema de gestión de inventario para tiendas de ropa',
    'VERSION': '1.0.0',
    ...
    # Configuración de autenticación para Swagger UI
    'SWAGGER_UI_SETTINGS': {
        'deepLinking': True,
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': True,             # Invalidar refresh usado
